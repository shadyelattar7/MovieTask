...
class PopularVC: BaseWireFrame<PopularViewModel> {
    ...
    override func bind(viewModel: PopularViewModel) {
    ...
    private func setupCollectionView() {
        ...
        popularCollectionView.registerNIB(MovieCell.self)
        customLayout()
    }
}
...
extension PopularVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func customLayout(){
        ...
        popularCollectionView?.contentInset = UIEdgeInsets(top: insetY, left: insetX, bottom: insetY, right: insetX)
        
    }
}

extension PopularVC: UIScrollViewDelegate{
